package es.padis.course.repository;

import es.padis.course.CourseApplicationApp;
import es.padis.course.config.Constants;
import es.padis.course.config.audit.AuditEventConverter;
import es.padis.course.domain.PersistentAuditEvent;
...
import static es.padis.course.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
